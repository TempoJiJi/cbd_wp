...
if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
	<p class="return-to-shop">
        ...
        $href = '';
          ...
          if ($option['empty_cart_button_url']) { 
		...
		<a class="button wc-backward<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" href="<?php echo esc_url($href); ?>">
			<?php
				/**
            ...
            if ($option['empty_cart_button_text']) { 
