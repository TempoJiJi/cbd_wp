...
<a <?php echo $this->get_render_attribute_string( 'marquee_link' ); ?>>
    <?php }
        ...
        ?>
      <?php  echo '<' . $settings['text_type']; ?> class="pe-marquee <?php echo $settings['seperator_rotate'] .' '. $settings['slip_direction'] .' ' . $settings['seperator_direction']. ' ' . $cursorInteraction ?><?php if ($settings['seperator_size'] !== 'Array') {echo ' icon_font'; } ?>" <?php echo 'data-duration=' . $settings['data_duration'] .' data-sepduration='. $settings['seperator_duration'];  ?> <?php echo $cursorSettings; ?>>
