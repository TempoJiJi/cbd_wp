   ...
   */
   protected function _register_controls() {
        ...
        $this->add_control(
            'blur_bg',
            [
                'label' => esc_html__('Blur Background', 'pe-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'pe-core'),
                'label_off' => esc_html__('Off', 'pe-core'),
                'return_value' => 'blur-bg'
            ]
        );
       ...
       $this->add_control(
            'color_bg',
            [
                'label' => esc_html__('Color Background', 'pe-core'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => esc_html__('On', 'pe-core'),
                'label_off' => esc_html__('Off', 'pe-core'),
                'return_value' => 'has-bg'
...
//                ],
//                'selectors' => [
//                    '{{WRAPPER}} .pe-circular-text.has-bg::after' => 'background-color: {{VALUE}}'
//                ]
//            ]
//        );
//       
...
<div class="pe-circular-text <?php echo $settings['rotate-direction'] . " " . $settings['blur_bg'] . " " . $settings['color_bg'] ?>" <?php echo "data-duration=" . $settings['data_duration'] . " " . 'data-height=' . $settings['data_height'] . ' '; if ( 'target' === $settings['target_type']) { echo 'data-target=' . $settings['target_id']; } ?>>
