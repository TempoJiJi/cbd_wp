 ...
 * @since 1.1.0
 */
class PeFullscreenCards extends Widget_Base {
  ...
  public function get_title() {
    return __( 'Pe Fullscreen Cards', 'pe-core' );
  }
   ...
   */
   protected function _register_controls() {
       ...
       $this->add_control(
        'speed',
           [
               'label' => esc_html__('Showcase Speed', 'pe-core'),
       ...
       $this->add_group_control(
        \Elementor\Group_Control_Typography::get_type(),
           [
               ...
               'selector' => '{{WRAPPER}} .leksa-fullscreen-cards .project-title'
           ]
       );
       ...
       $this->add_group_control(
        \Elementor\Group_Control_Typography::get_type(),
           [
               ...
               'selector' => '{{WRAPPER}} .leksa-fullscreen-cards .project-category'
           ]
       );
       ...
       $this->add_responsive_control(
        'project_width',
           [
               ...
               'selectors' => [
                   '{{WRAPPER}} .leksa-fullscreen-cards .fullscreen-cards-wrapper' => 'width: {{SIZE}}{{UNIT}}'
               ] 
           ]
       );
       ...
       $this->add_responsive_control(
        'project_height',
           [
               ...
               'selectors' => [
                   '{{WRAPPER}} .leksa-fullscreen-cards .fullscreen-cards-wrapper' => 'height: {{SIZE}}{{UNIT}}'
               ] 
           ]
       );
       ...
       $this->add_responsive_control(
           ...
           [
               ...
               'selectors' => [
                   '{{WRAPPER}} .leksa-fullscreen-cards .project-image' => 'border-radius:{{TOP}}{{UNIT}}  {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
                   '{{WRAPPER}} .leksa-fullscreen-cards .project-image .pe-video' => 'border-radius:{{TOP}}{{UNIT}}  {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
               ]
           ]
       );
...
<div class="leksa-fullscreen-cards" data-target-id="<?php if ($settings['target_container']) { echo $settings['target_container']; } else { echo 'no-target'; } ?>" data-speed="<?php echo $settings['speed']; ?>">

    <div class="fullscreen-cards-wrapper anim-multiple"  <?php echo pe_general_animation($this) ?>>

        <?php foreach ($settings['project_repeater'] as $item) { ?>

        <div class="showcase-project">
            
            <a class="barba--trigger inner--anim" href="<?php echo get_the_permalink($item['select_project']); ?>" <?php echo $cursor ?> data-id="<?php echo $item['select_project']; ?>" <?php echo $cursor ?> >
