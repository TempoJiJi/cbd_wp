   ...
   */
   protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_tab_title',
            [
                'label' => __( 'Testimonials', 'your-custom-plugin' ),
            ]
        );
...
<div class="pe--testimonials <?php echo esc_attr($mainClasses); ?>" <?php echo $animationSettings; ?>>
    ...
    ?>
                ...
                <div class="pt-content">
                    ...
                    <p class="p-large"><?php echo esc_html($testimonial['testimonial_text']) ?></p>
