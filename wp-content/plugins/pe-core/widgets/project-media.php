...
class peProjectMedia extends Widget_Base
{
	...
	protected function _register_controls()
	{
		...
		$this->start_controls_section(
			'section_tab_title',
			[
				'label' => __('Project Media', 'your-custom-plugin'),
			]
		);
	...
	protected function render()
	{
		...
		<?php if ($type === 'featured') { ?>
			...
			<?php if ($settings['linked'] === 'yes') { ?>
				...
				<div <?php echo pe_image_animation($this); ?> class="project-featured-image <?php echo esc_attr($classes) ?>">
		...
		<?php } else if ($type === 'gallery') { ?>
				...
				<div class="project--image--gallery" data-trigger="<?php echo esc_attr($settings['pin_target']) ?>"
					...
					<div class="project--image--gallery--wrapper" data-id="<?php echo esc_attr($settings['gallery_id']) ?>">
						...
						<div class="project--gallery--image p--featured cr--item  <?php echo esc_attr('featured__' . $id) ?>">
		...
		<?php } else if ($type === 'video-player') {
			...
			if ($provider == 'self') { ?>
						...
						<!-- Pe Video -->
						<div class="pe-video no-interactions p-self" data-controls="play,current-time,duration,progress,mute,volume,fullscreen"
							data-autoplay="true" data-muted="true" data-loop="true" data-lightbox="true">
   ...
   <svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" viewBox="0 -960 960 960" width="24"><path d="M320-200v-560l440 280-440 280Z"/></svg>
			...
			<?php } else if ($provider == 'vimeo') { ?>
							...
							<div class="pe-video n-vimeo no-interactions" data-controls="play,current-time,duration,progress,mute,volume,fullscreen"
								data-autoplay="true" data-muted="true" data-loop="true" data-lightbox="true">
   ...
   <svg xmlns="http://www.w3.org/2000/svg" height="100%" width="100%" viewBox="0 -960 960 960" width="24"><path d="M320-200v-560l440 280-440 280Z"/></svg>
			...
			<?php } else if ($provider == 'youtube') { ?>
								...
								<div class="pe-video no-interactions p-youtube"
