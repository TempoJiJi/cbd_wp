       ...
       $repeater->add_control(
		...
		$this->add_control(
			...
			[
                ...
                'default' => [
					[
						'client_title' => esc_html__( 'Client #1', 'textdomain' ),
					],
                    [
						'client_title' => esc_html__( 'Client #2', 'textdomain' ),
					],
                    [
						'client_title' => esc_html__( 'Client #3', 'textdomain' ),
					],
				],
...
pe_cursor_settings($this);
    ...
    protected function render() {
        ...
        array_push($classes , [$settings['type'] , $settings['background'] , $settings['hover'] , $settings['hover-switch'] , $settings['captions'] , $animation]);
...
<!-- Pe Clients Grid -->
<div class="pe--clients <?php echo esc_attr($mainClasses); ?>" <?php echo $animationSettings; ?>>
