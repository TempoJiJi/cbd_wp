...
?>
		...
		<div class="pe--portfolio anim-multiple <?php echo $settings['show_counts'] . ' ' . $settings['portfolio_style'] ?>" data-max-pages="<?php echo esc_attr($loop->max_num_pages) ?>" <?php echo pe_general_animation($this) ?>>
				...
				<?php if ($settings['filterable'] === 'yes') { ?>
					<div class="portfolio--filters">
						...
						<div data-length="<?php echo '(' . $loop->found_posts . ')'; ?>" class="filter--active" data-cat="all">
							<?php echo esc_html($settings['view_all_text']) ?></div>
				...
				<?php if ($settings['style_switcher'] === 'yes') { ?>
					<div class="pe--switcher">
						...
						<div class="ps--switch">
							...
							<span class="ps--item ps--grid"><?php echo esc_html($settings['switch_grid_text']) ?></span>
							<span class="ps--item ps--list"><?php echo esc_html($settings['switch_list_text']) ?></span>
				...
				while ($loop->have_posts()) :
					...
					<div class="portfolio--project inner--anim">
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
							...
							<a class="barba--trigger" href="<?php echo get_the_permalink() ?>" <?php echo $cursor ?> data-id="<?php the_ID(); ?>">
								...
								<div class="project--details">
									...
									<div class="project--tc">
										...
										<div class="project--icon">
											...
											<i aria-hidden="true" class="material-icons-sharp md-arrow_outward" data-md-icon="arrow_outward"></i>
									...
									<div class="project--meta">
										...
										<div class="project--meta--top">
											...
											<?php if (get_field('excerpt') && $settings['excerpt'] === 'true') { ?>
