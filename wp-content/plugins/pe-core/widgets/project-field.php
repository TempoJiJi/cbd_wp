...
class PeProjectField extends Widget_Base
{
    ...
    protected function render()
    {
        ...
        <div class="text-wrapper">
            ...
            <<?php if ($settings['use_heading'] === 'heading__on') {
                 if ($settings['heading_type']) {
                     echo $settings['heading_type']; } else { 
                        echo 'p'; } } else { echo 'p'; } ?> <?php echo $this->get_render_attribute_string('attributes') ?><?php echo pe_text_animation($this) ?> >
                <?php echo $text; ?>
            </<?php if ($settings['use_heading'] === 'heading__on') {
                 if ($settings['heading_type']) {
                     echo $settings['heading_type']; } else { 
